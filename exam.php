   ...
   <div class="container">
    ...
    <div class="content">
      ...
      <div>
        ...
        $sql = "SELECT exam.Nom_exam, module.Nom_mdl, exam.date_debut FROM exam, module WHERE exam.ID_mdl = module.ID_mdl";
        $stmt = $conn->query($sql);
   ...
   <tbody>
     ...
     <?php endwhile; ?>
      ...
      <div id="id01" class="MDL">
        <form class="MDL-content animate" action="exam-mod.php" method="post">
          <div class="fermer">
      ...
      if($stmt2 === false){
        ...
        ?>
            ...
            <label for="date_debut"><b>Date de debut </b></label>
