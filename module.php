   ...
   <div class="container">
    ...
    <div class="content">
      ...
      <div>
        ...
        $sql = "SELECT module.Nom_mdl, module.filiere, professeur.Nom_prof FROM module, professeur WHERE module.ID_prof = professeur.ID_prof";
        $stmt = $conn->query($sql);
   ...
   <tbody>
     ...
     <?php endwhile; ?>
      ...
      <div id="id01" class="MDL">
        <form class="MDL-content animate" action="module-mod.php" method="post">
          <div class="fermer">
